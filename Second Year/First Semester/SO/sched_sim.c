//Echipa: Dobre Adriana Lia, Gutu Stefania Alexandra, Pirlogea Luciana Elena (grupa 241)
//Proiectul nr. 10
#include <stdio.h>
#include <stdlib.h>
#include <stdbool.h>
...
//algoritmul de scheduling Priority Scheduling ia procesele in ordinea timpului de sosire, 
//apoi daca au acelasi timp de sosire le ia in functie de prioritate 
void Priority_Scheduling()
{
  ...
  for(int i=0; i < nr_processes-1;i++)
    ...
    {
      if(processes[i].arrival_time > processes[j].arrival_time || (processes[i].arrival_time == processes[j].arrival_time 
...
//Algoritmul Round_Robin_Scheduling ia procesele in functie de timpul de sosire, iar daca burst_time -ul unui proces 
//este mai mare decat quantumul dat pune procesul respectiv in coada si trece la urmatorul proces ajuns 
